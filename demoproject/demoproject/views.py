...
def start_detection(request):
    ...
    while True:
        ...
        # Convert BGR color (7, 155, 219) to RGB color (219, 155, 7)
        blue_color_bgr = (244, 235, 20, 1)
        blue_color_rgb = (blue_color_bgr[2], blue_color_bgr[1], blue_color_bgr[0])
    ...
    detection_thread = Thread(target=face_detection_thread)
